            ...
            <MDBRow>
                <MDBCol md="12">
                    <MDBCard>
                        <MDBCardHeader>
                            <MDBRow>
                                <MDBCol md="6"><MDBCardTitle><MDBIcon className="fas fa-tasks"/> Members</MDBCardTitle></MDBCol>
                                <MDBCol md="6">
                                <MDBInput type="text" label="search" onChange={(e) => setQuery(e.target.value)}/>
                        ...
                        <MDBFooter>
                            <MDBBtn className="btn btn-primary mb-4 m-4 float-end" onClick={()=>setShow(!show)}>Add Resource</MDBBtn>
                        </MDBFooter>
                    </MDBCard>
                </MDBCol>
            </MDBRow>
        ...
        >
          <div className="modal-content">
            ...
            <div className="modal-footer d-flex justify-content-center">
                <MDBBtn className="btn btn-primary" onClick={handleResource}>Add</MDBBtn>
