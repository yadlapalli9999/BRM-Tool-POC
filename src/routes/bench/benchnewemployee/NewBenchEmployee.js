...
import { createBench, getBenchId, updateBench } from "../../../redux/features/bench/bench.feature";
...
let NewBenchEmployee = () => {
  ...
  let handleSubmitForm =(event)=>{
    ...
    if(!newBench.name || !newBench.email || !newBench.emp_id || !newBench.status || !newBench.projectName){
    ...
    <React.Fragment>
      {/* <div className="container-lg"> */}
        ...
        <MDBCard className="mt-5 mb-5">
           <MDBCardHeader>
             <MDBCardTitle className="text-center"><h2>{id?'Update':'New'} Bench Employee</h2></MDBCardTitle>
           </MDBCardHeader>
           <MDBCardBody>
           {/* <pre>{JSON.stringify(newBench)}</pre> */}
           <MDBValidation className="row g-5 novalidate" noValidate onSubmit={handleSubmitForm}>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your name'>
              <MDBInput id='validationCustom01' type="text" name="name" value={newBench.name} onChange={handleUpdateInput} required label="Name"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your EmpId' invalid>
              <MDBInput id='validationCustom02' type="text" required name="emp_id" value={newBench.emp_id} onChange={handleUpdateInput} label="EmpId"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your Email' invalid>
              <MDBInput id='validationCustom03' type="email" required name="email" value={newBench.email} onChange={handleUpdateInput} label="Email"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your Email' invalid>
              <MDBInput id='validationCustom04' type="password" required name="password" value={newBench.password} onChange={handleUpdateInput} label="Password"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your TotalWorkExp' invalid>
              <MDBInput id='validationCustom05' type="number" required name="totalWorkExp" value={newBench.totalWorkExp} onChange={handleUpdateInput} label="TotalWorkExp"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your TotalExpFission' invalid>
              <MDBInput id='validationCustom06' type="number" required name="totalExpinFission" value={newBench.totalExpinFission} onChange={handleUpdateInput} label="TotalExpFission"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your PrimarySkill' invalid>
              <MDBInput id='validationCustom07' type="text" required name="skillName" value={newBench.primarySkills.skillName} onChange={handleUpdatePrimarySkillsInput} label="skillName"/>
           </MDBValidationItem>
           ...
           <MDBValidationItem className="col-md-4" feedback='Please Enter your Reporting Manager' invalid>
              <MDBInput id='validationCustom09' type="text" required name="reportingManager" value={newBench.reportingManager} onChange={handleUpdateInput} label="Reporting Manager"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your Team Lead' invalid>
              <MDBInput id='validationCustom10'  type="text" required name="teamLead" value={newBench.teamLead} onChange={handleUpdateInput} label="TeamLead"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your Status' invalid>
              <MDBInput id='validationCustom11' type="text" required name="projectName" value={newBench.projectName} onChange={handleUpdateInput} label="projectName"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-4" feedback='Please Enter your Status' invalid>
              <MDBInput id='validationCustom12' type="text" required name="status" value={newBench.status} onChange={handleUpdateInput} label="Status"/>
           </MDBValidationItem>
           <MDBValidationItem className="col-md-13" feedback='Please Enter your notes' invalid>
              <MDBTextArea id='validationTextarea' required name="notes" value={newBench.notes} onChange={handleUpdateInput} label="Notes"/>
           </MDBValidationItem>
           <div className='col-12 text-center'>
        <MDBBtn className="m-2" type='submit'>{id?'Update':'Add'}</MDBBtn>
